...
const worksData = [
    ...
    },
    {
        title: "Codewars",
        src: codewars,
        text: "As I continuously improve my programming skills and algorithm-solving abilities, the list of solved problems grows every day. Currently, I am in the top 0.7% of users by honor level, with more than 800 solved problems",
        type: "js",
        id: 2,
